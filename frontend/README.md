...
- [x] Change `<title>` to "Cafeteria Chaos" and update the favicon.
- [x] Add a pop-up at the end of the game to collect name and email for YETI giveaway (with "Enter" and "Skip" options, YETI image, and thank you message).
- [x] Save pop-up information and submit it into the top ten at the same time.
